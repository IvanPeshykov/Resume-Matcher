...
export const SwissGrid = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    ...
    <div
      className="h-screen w-full flex justify-center items-center py-12 px-4 md:px-8 overflow-hidden bg-[#F0F0E8]"
      style={{
        backgroundImage:
      ...
      <div className="w-full max-w-[86rem] max-h-full border border-black bg-[#F0F0E8] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)] flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-[#F0F0E8] flex justify-between items-center font-mono text-xs text-blue-700 border-t border-black shrink-0 relative z-30">
          <div className="flex items-center gap-2">
            <img src="/logo.svg" alt="Landed Job" className="w-5 h-5" />
            <span className="uppercase font-bold text-base">
              <span className="text-[#1F2937] pl-1 rounded-l">LANDED</span>
              <span className="text-blue-700 rounded-r">JOB</span>
            </span>
          </div>
        </div>
      </div>
